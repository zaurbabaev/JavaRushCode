package az.babayev.javarush.javasyntax.task.task19.task1819;
...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println("Only negative numbers int the stream? " + answerOnlyNegativeNumbers);

    }

    public static boolean hasNegativeEvenNumbers(Stream<Integer> stream) {
        return stream.anyMatch(integer -> (integer % 2 == 0) && (integer < 0));
    }
